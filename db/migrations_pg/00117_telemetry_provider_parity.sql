-- PG port of 00117_telemetry_provider_parity.sql | status: NEEDS-REVIEW | flags: HAS-DQUOTE | reviewed: YES
-- +goose Up
...
ALTER TABLE telemetry_positions ADD COLUMN fix_time TIMESTAMPTZ;
