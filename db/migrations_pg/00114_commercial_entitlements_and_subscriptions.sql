-- PG port of 00114_commercial_entitlements_and_subscriptions.sql | status: NEEDS-REVIEW | flags: HAS-DQUOTE | reviewed: YES
-- +goose Up
...
-- Seed Standard Plans
INSERT INTO subscription_plans (id, name, description, monthly_price_inr, features_json, quotas_json)
VALUES
...
('ENTERPRISE', 'Enterprise Custom', 'Custom Contractual Operations', 0.00,
 ...
 '{"max_vehicles": 100000, "max_drivers": 100000, "max_trips_per_month": 1000000, "max_dispatcher_seats": 1000}') ON CONFLICT DO NOTHING;
-- +goose Down
