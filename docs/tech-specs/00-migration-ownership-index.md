...
| 00143 | `maintenance_plans` table (IP41 single cycle plans, measuring point annual estimate projection) + work_orders plan_id/due_km + tenant FK triggers | Fleet SOP Parity B3 (pp.10-15) |
| 00144+ | future specs | reserved |
