...
export function DispatchScreen() {
  ...
  const handleEnableLocation = async () => {
    ...
    } else Alert.alert(t('dispatch.loc_title', 'Location', locale), perms.error || t('dispatch.loc_denied', 'Permission denied', locale));
  };
...
const styles = StyleSheet.create({
  ...
  infoTitle: { fontSize: FontSize.body, fontWeight: '800', color: Colors.textPrimary, letterSpacing: 1.5 },
  infoMeta: { fontSize: FontSize.caption, fontWeight: '700', color: Colors.textMuted, letterSpacing: 1 },
  infoBody: { fontSize: FontSize.body, color: Colors.textSecondary, lineHeight: 18, marginBottom: Spacing.md },
  ...
  locationText: { fontSize: FontSize.body, fontWeight: '700', color: Colors.textPrimary, flex: 1 },
  routeConnector: { width: 1, height: 10, backgroundColor: Colors.border, marginLeft: 3.5 },
  hint: { fontSize: FontSize.small, color: Colors.textMuted, fontStyle: 'italic' },
  telemetryRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center' },
  telemetryLabel: { fontSize: FontSize.small, fontWeight: '800', color: Colors.textPrimary, letterSpacing: 1 },
  ...
  telemetryValue: { fontSize: FontSize.caption, fontWeight: '800', letterSpacing: 1 },
  ...
  actionBtnTeal: { backgroundColor: Colors.primary }, actionBtnText: { color: Colors.textOnPrimary, fontSize: FontSize.label, fontWeight: '800', letterSpacing: 1.5 },
});
