...
- Full policy: "Security Gate" section in AGENTS.md ("Prove It" Protocol
  step 6). Every task response ends with the Agent Verification Report
  including a Security Check line.
