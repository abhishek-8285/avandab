...
func TestAllTemplatesRender(t *testing.T) {
	...
	tests := []struct {
		...
		{"consumer_compliance", "consumer_compliance.html", map[string]interface{}{"Version": AppVersion}},
		...
		{"customer_statement", "customer_statement.html", map[string]interface{}{
			"Customer": domain.Customer{
				ID: "c-1", Name: "ACME Corp", Phone: "9999999999",
				Company: sPtr("ACME Ltd"), Email: sPtr("acme@example.com"),
				GST: sPtr("27AAACP0000M1Z9"), Address: sPtr("Mumbai"),
			...
			"Statement": &CustomerStatementData{
				...
				TotalUnbilledAmount: 15000,
				NetBalanceDue:       45000,
				Aging: CreditAgingSummary{
					CurrentOr15:      10000,
					Days16To30:       10000,
					Days31To60:       10000,
					Days60Plus:       0,
				...
				Transactions: []StatementTransaction{
					{
						...
						Type:        "Invoice",
						Reference:   "INV-001",
						Description: "Tax Invoice #INV-001",
						Debit:       23600,
						Credit:      0,
						Balance:     23600,
					},
				},
				WhatsAppShareURL: "https://wa.me/919876543210",
			},
		}},
		...
		{"epod_receipt", "epod_receipt.html", EPODReceiptView{
			TripID:            "trip-1",
			TripNumber:        "TRIP-001",
			Status:            "delivered",
			CompanyName:       "FlyFleet Logistics",
			VehicleReg:        "KA-01-EQ-5555",
			DriverName:        "Rajesh Kumar",
			DriverPhone:       "+91 9876543210",
			DepartureTime:     "01 Sep 2026, 08:00",
			DeliveredAt:       "01 Sep 2026, 14:30 UTC",
			StopSequence:      1,
			StopType:          "drop",
			LocationName:      "Bengaluru Terminal",
			Address:           "Hosur Road, Bengaluru",
			ConsigneeName:     "Amit Patel",
			ConsigneePhone:    "+91 9123456780",
			ConsigneeEmail:    "amit@example.com",
			OTPRequired:       true,
			OTPVerified:       true,
			OTPVerifiedAt:     "01 Sep 2026, 14:25 UTC",
			PODRequired:       true,
			PODVerified:       true,
			PODURL:            "/uploads/pod/photo.jpg",
			SignatureURL:      "/uploads/pod/sig.png",
			Notes:             "Delivered in good condition",
			VerificationHash:  "A1B2C3D4E5F6",
			CertificateNumber: "EPOD-TRIP-001",
			GeneratedAt:       "01 Sep 2026, 15:00 UTC",
		...
		{"partial_seo_head", "seo_head.html", map[string]interface{}{
			"Title": "Test", "SEODescription": "Test description", "CanonicalPath": "/test",
			"NoIndex": false, "OGImage": "", "OGType": "website", "Version": AppVersion,
		}},
		...
		{"invoice_pay", "invoice_pay.html", PublicPayData{
			Title: "Pay Invoice INV-2026-001 · Avandab Logistics",
			Invoice: PublicInvoiceView{
				ID:                 "inv-101",
				InvoiceNumber:      "INV-2026-001",
				CustomerName:       "Rajesh Logistics",
				Total:              11800.0,
				Subtotal:           10000.0,
				Tax:                1800.0,
				OutstandingBalance: 11800.0,
